...
#ifndef INCLUDED_BASLER1394CAMERAEVENTHANDLER_H_3102315
#define INCLUDED_BASLER1394CAMERAEVENTHANDLER_H_3102315
...
namespace Pylon
{
    ...
    /**
    \class  CBasler1394CameraEventHandler
    ...
    */
    ...
    public:
        ...
        */
        virtual void OnCameraEvent( CBasler1394InstantCamera& camera, intptr_t userProvidedId, GENAPI_NAMESPACE::INode* pNode)
        {
        }
        ...
        \param[in]  userProvidedId  This ID is passed as a parameter in CBasler1394CameraEventHandler::OnCameraEvent and can be used to distinguish between different events.
        ...
        */
        virtual void OnCameraEventHandlerRegistered( CBasler1394InstantCamera& camera, const String_t& nodeName, intptr_t userProvidedId)
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera event handler registry.
        */
        virtual void OnCameraEventHandlerDeregistered( CBasler1394InstantCamera& camera, const String_t& nodeName, intptr_t userProvidedId)
        {
        }
        ...
        */
        ...
        /// Create.
        CBasler1394CameraEventHandler()
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Copy.
        CBasler1394CameraEventHandler(const CBasler1394CameraEventHandler&)
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Assign.
        CBasler1394CameraEventHandler& operator=(const CBasler1394CameraEventHandler&)
        {
            return *this;
        }

        /// Destruct.
        virtual ~CBasler1394CameraEventHandler()
        {
...
#endif /* INCLUDED_BASLER1394CAMERAEVENTHANDLER_H_3102315 */
