...
ZV_EXPORTS int zv_modInit(bool isBlocking);
ZV_EXPORTS int zv_modExit();

/*************************************************************
Description:    //创建图像结构体头
Input:          //无
Output:         //无
Return:         //创建的图像指针
*************************************************************/
ZV_EXPORTS ZvImage zv_modImgCreate();
...
Return:         //创建的图像指针
*************************************************************/
ZV_EXPORTS ZvImage zv_modImgCreateData(int width, int height, int depth, int cn, void *data);
...
Return:         //创建的图像指针
*************************************************************/
ZV_EXPORTS ZvImage zv_modImgCreateConst(int width, int height, int depth, int cn, double value);
...
Return:         //错误码
*************************************************************/
ZV_EXPORTS int zv_modImgRelease(ZvImage * img);
...
/*************************************************************
Description:    //创建模板图像类结构体
Output:         //五
Return:         //创建的模板图像类型指针
*************************************************************/
ZV_EXPORTS ZvModel zv_zvModelCreate();
//sys
#ifndef ZV_BUILD_DLL
...
//    int anchorX, int anchorY, double delta, char * border);
...
//    ZvMatrix centroid, int connectivity);
...
ZV_TASK ZV_EXPORTS int zv_matchNccFind(ZvModel mod, ZvImage img, ZvMatrix matchs, int NumLevel, double minScore,
    double *x, double *y, double minDist, int isSubPix);
